...
- The directory `AtkinKernelPolys` contains the conjectured kernel polynomial formulas associated to the Atkin modular polynomials, together with an explanation of how to use them and how they were derived.
...
- The script `qExpansions.sage` demonstrates the low precision q-expansion of the Hauptmodul given in Proposition 8.
